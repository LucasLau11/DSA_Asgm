...
public class PatientUI {
    ...
    // Constructor that accepts shared PatientManager
    ...
    private void registerPatientOrAddVisit() {
        System.out.println("\n" + repeat("=", 60));
    ...
    private Patient inputPatientDetails() {
        ...
        while (id == null || id.trim().isEmpty()) {
            ...
            if (id.isEmpty()) {
                showErrorMessage("Patient ID cannot be empty. Please try again.");
            }
        }
    ...
    private Patient inputPatientDetailsWithId(String id) {
        try {
            ...
            int age = getIntInput("");
            if (age <= 0 || age > 150) {
                showErrorMessage("Please enter a valid age (1-150).");
                return null;
            }
            ...
            String gender = scanner.nextLine().trim();
            if (gender.isEmpty()) {
                showErrorMessage("Gender cannot be empty.");
                return null;
            }
            ...
            String contactNumber = scanner.nextLine().trim();
            if (contactNumber.isEmpty()) {
                showErrorMessage("Contact number cannot be empty.");
                return null;
            }
            ...
            String illnessDescription = scanner.nextLine().trim();
            if (illnessDescription.isEmpty()) {
                showErrorMessage("Illness description cannot be empty.");
                return null;
            }
